...
namespace Tag.Events.DI;

public static class ServiceCollectionExtensions
{
    public static IServiceCollection AddTagEvents(this IServiceCollection services)
    {
        ...
        services.AddScoped<IEventHandler<ProjectCreatedEvent>, ProjectEventsHandler>();
